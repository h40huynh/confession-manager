    ...
    <main id="mainContent">
      <div className="container">
        <div className="form-group">
          ...
          <small id="typeHelpBlock" className="form-text text-muted">
        ...
        <div className="form-group">
          ...
          <small id="contentHelpBlock" className="form-text text-muted">
            <b>Lưu ý:</b> sử dụng ngôn ngữ phù hợp, hạn chế nhắc tên cụ thể một
            bạn nào đó để tránh gây phiền phức. Quan trọng nhất, viết tắt thì
            một số quản trị viên sẽ xóa bài.
          </small>
        </div>

        <div className="text-center">
          <button className="btn btn-primary" onClick={sendConfession}>
            Gửi confession
          </button>
        </div>
      </div>
